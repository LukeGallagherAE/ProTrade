...
import { Database, TeamMember, Customer, Job, Quote, Invoice } from './types';

// Support Railway Volume mount via DATA_DIR env var
...
function seedData(): Database {
  ...
  const jobs: Job[] = [
    ...
    { id: 'j6', jobNumber: 'JOB-1006', title: 'Blocked Drain Clearance', description: 'Main drain blockage causing backup', customerId: 'c1', customerName: 'David Thompson', assignedTo: ['tm2', 'tm4'], status: 'completed', priority: 'urgent', jobType: 'Plumbing', scheduledDate: d(-5), scheduledTime: '08:00', completedDate: d(-5), address: '14 Elm Street, Brisbane QLD 4000', notes: 'Tree roots in drain', timeEntries: [{ id: 'te3', memberId: 'tm2', memberName: 'Sarah Chen', date: d(-5), hours: 3, notes: 'Hydro jetting required' }], materials: [{ id: 'm3', name: 'Root treatment chemical', quantity: 1, unit: 'L', cost: 45 }], createdAt: now, updatedAt: now },
  ];

  const quotes: Quote[] = [
    { id: 'q1', quoteNumber: 'QT-101', customerId: 'c3', customerName: 'Steve Nguyen', title: 'Office Fitout - Full Electrical Package', description: 'Complete electrical fitout for new office space', lineItems: [{ id: 'li1', description: 'Labour - Electrician (40hrs)', quantity: 40, unit: 'hr', unitPrice: 95, total: 3800 }, { id: 'li2', description: 'Labour - Apprentice (40hrs)', quantity: 40, unit: 'hr', unitPrice: 35, total: 1400 }, { id: 'li3', description: 'Power points (double GPO)', quantity: 24, unit: 'ea', unitPrice: 85, total: 2040 }, { id: 'li4', description: 'LED Downlights', quantity: 32, unit: 'ea', unitPrice: 65, total: 2080 }, { id: 'li5', description: 'Data/comms cabling', quantity: 1, unit: 'lot', unitPrice: 1200, total: 1200 }], subtotal: 10520, taxRate: 10, tax: 1052, total: 11572, status: 'sent', validUntil: new Date(Date.now() + 30 * 86400000).toISOString().split('T')[0], createdAt: now, updatedAt: now, notes: 'Quote valid for 30 days', terms: 'Payment due within 14 days of invoice.' },
    { id: 'q2', quoteNumber: 'QT-102', customerId: 'c5', customerName: 'Mark Johnson', title: 'New Home - Rough-in Electrical', description: 'Full rough-in electrical for new residential build', lineItems: [{ id: 'li6', description: 'Labour - Electrician (60hrs)', quantity: 60, unit: 'hr', unitPrice: 95, total: 5700 }, { id: 'li7', description: 'Main switchboard supply & install', quantity: 1, unit: 'ea', unitPrice: 1800, total: 1800 }, { id: 'li8', description: 'Cabling and conduit', quantity: 1, unit: 'lot', unitPrice: 2400, total: 2400 }], subtotal: 9900, taxRate: 10, tax: 990, total: 10890, status: 'draft', validUntil: new Date(Date.now() + 14 * 86400000).toISOString().split('T')[0], createdAt: now, updatedAt: now, notes: '', terms: 'Payment due within 14 days of invoice.' },
  ];

  const invoices: Invoice[] = [
    { id: 'inv1', invoiceNumber: 'INV-101', customerId: 'c4', customerName: 'Lucy Patel', jobId: 'j4', quoteId: '', title: 'Leaking Tap Repair', lineItems: [{ id: 'li9', description: 'Labour - Plumber (2hrs)', quantity: 2, unit: 'hr', unitPrice: 85, total: 170 }, { id: 'li10', description: 'Tap washers', quantity: 1, unit: 'pack', unitPrice: 18, total: 18 }, { id: 'li11', description: 'Call-out fee', quantity: 1, unit: 'ea', unitPrice: 75, total: 75 }], subtotal: 263, taxRate: 10, tax: 26.30, total: 289.30, status: 'paid', dueDate: d(-10), paidDate: d(-8), createdAt: now, updatedAt: now, notes: '', terms: 'Thank you for your business!' },
    { id: 'inv2', invoiceNumber: 'INV-102', customerId: 'c1', customerName: 'David Thompson', jobId: 'j6', quoteId: '', title: 'Blocked Drain Clearance', lineItems: [{ id: 'li12', description: 'Labour - Plumber (3hrs)', quantity: 3, unit: 'hr', unitPrice: 85, total: 255 }, { id: 'li13', description: 'Hydro jetting service', quantity: 1, unit: 'ea', unitPrice: 350, total: 350 }, { id: 'li14', description: 'Root treatment chemical', quantity: 1, unit: 'ea', unitPrice: 65, total: 65 }, { id: 'li15', description: 'Urgent call-out fee', quantity: 1, unit: 'ea', unitPrice: 120, total: 120 }], subtotal: 790, taxRate: 10, tax: 79, total: 869, status: 'sent', dueDate: d(7), paidDate: '', createdAt: now, updatedAt: now, notes: 'Urgent call-out surcharge applied', terms: 'Payment due within 14 days.' },
    { id: 'inv3', invoiceNumber: 'INV-103', customerId: 'c2', customerName: 'Megan Roberts', jobId: '', quoteId: '', title: 'Maintenance Contract - Q1', lineItems: [{ id: 'li16', description: 'Quarterly maintenance - electrical', quantity: 1, unit: 'ea', unitPrice: 450, total: 450 }, { id: 'li17', description: 'Quarterly maintenance - plumbing', quantity: 1, unit: 'ea', unitPrice: 350, total: 350 }], subtotal: 800, taxRate: 10, tax: 80, total: 880, status: 'overdue', dueDate: d(-15), paidDate: '', createdAt: now, updatedAt: now, notes: '', terms: 'Payment due within 14 days.' },
  ];

  return {
    jobs, customers, quotes, invoices, team,
